...
joka ottaa \code{Char} arvon parametrinään ja palauttaa tyhjän IO-toiminnon, jonka tyyppi on
...
% do näyttää helpolta ja imperatiiviselta
...
\code{nimi} ja tulostaa tekstiä käyttäen saamaansa parametriä.
...
%       järjestää toiminnot ja estää kääntäjää optimoimasta niitä pois.

\fixme{Konsepti virtuaalisesta Maailma'sta}
