...
\fixme{Ajatus. Miten jos aluksi kertoisi monadeista kaiken, ja sitten kun monadit on kerrottu, voi
kertoa, kuinka IO-monadin kontekstissa voidaan tehdä RealWorldin passaamminen ja hävittäminen,
jolloin on kauniisti palattu takaisin listaukseen 6.}
...
Kappale, jossa viitataan~\cite{hoh07} kaikkiin~\cite{tcih96} lähteisiin, että ne~\cite{ifp93}
tulevat~\cite{moggi89} näkyviin~\cite{cm90} lopussa.
